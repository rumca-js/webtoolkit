...
class Email(object):
    """
    Provides fields similar to ContentInterface
    author - sender
    """
    def __init__(self):
        self.title = None
...
class EmailReader(object):
    ...
    def read_emails_impl(self, email_ids):
        """
        Reads all emails within time limit
        Note: generator
        """
    ...
    def read_email_impl(self, email_id) -> Email:
        """
        Read email into email structure
        @return email
        """
